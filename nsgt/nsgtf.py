...
def nsgtf_sl(f_slices,g,wins,nn,M=None,measurefft=False):
    M = chkM(M,g)
...
# non-sliced version
def nsgtf(f,g,wins,nn,M=None,measurefft=False):
    return nsgtf_sl((f,),g,wins,nn,M=M,measurefft=measurefft).next()
